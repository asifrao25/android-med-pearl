...
fun MainScaffold(
    ...
    Box(Modifier.fillMaxSize().interactiveKeyboardDismiss()) {
        ...
        SettingsScreen(
            ...
            onPrepareRestore = settingsViewModel::prepareRestoreFromPath,
            onPrepareImport = settingsViewModel::prepareRestoreFromUri,
            onConfirmRestoreMerge = settingsViewModel::confirmRestoreMerge,
            onConfirmRestoreReplace = settingsViewModel::confirmRestoreReplace,
            onCancelPendingRestore = settingsViewModel::cancelPendingRestore,
